            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-lg-12">
                        <h2>About me</h2>
                        <p>With over 7 years of dedicated experience in designing products that drive business success, I’ve built a reputation as a reliable and results-driven professional in the industry.</p>
                    </div>
                </div>
                {/*<div className="row">
